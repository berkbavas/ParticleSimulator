...
const QMatrix4x4& ParticleSimulator::Node::GetTransformation() const
{
...
void ParticleSimulator::Node::SetScale(float UniformScale)
{
...
const QQuaternion& ParticleSimulator::Node::GetRotation() const
{
    return mRotation;
}

const QVector3D& ParticleSimulator::Node::GetPosition() const
{
    return mPosition;
}

const QVector3D& ParticleSimulator::Node::GetScale() const
{
    return mScale;
}

const QMatrix3x3& ParticleSimulator::Node::GetNormalMatrix() const
{
