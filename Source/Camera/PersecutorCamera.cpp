...
bool ParticleSimulator::PersecutorCamera::OnMousePressed(QMouseEvent* pEvent)
{
    bool Consumed = false;
...
bool ParticleSimulator::PersecutorCamera::OnMouseReleased(QMouseEvent* pEvent)
{
...
bool ParticleSimulator::PersecutorCamera::OnMouseMoved(QMouseEvent* pEvent)
{
    bool Consumed = false;
...
bool ParticleSimulator::PersecutorCamera::OnWheelMoved(QWheelEvent* pEvent)
{
...
void ParticleSimulator::PersecutorCamera::Update(float Ifps)
{
    HandleRotation(Ifps);
    HandleZoom(Ifps);
...
void ParticleSimulator::PersecutorCamera::HandleZoom(float Ifps)
{
...
void ParticleSimulator::PersecutorCamera::HandleRotation(float Ifps)
{
...
void ParticleSimulator::PersecutorCamera::HandleTranslation(float Ifps)
{
...
void ParticleSimulator::PersecutorCamera::Reset()
{
    mDistance = 5.0f;
    mYaw = 0.0f;
    mPitch = 0.0f;
...
ParticleSimulator::Node* ParticleSimulator::PersecutorCamera::GetTarget() const
{
    return mTarget;
}

void ParticleSimulator::PersecutorCamera::SetTarget(Node* pNewTarget)
{
...
void ParticleSimulator::PersecutorCamera::ClampAngles()
{
